...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="/last/admin/admin.php?action=index"><i class="fa fa-dashboard"></i> Главная</a></li>
    ...
    <section class="content">
      ...
      <div class="form-group">
                  <label for="exampleInputEmail1">Изменить пароль администратора</label>
        <input type="password" class="form-control" id="changePassword" placeholder="Введите новый пароль"><br>
        <a href="javascript:;" onclick="changeP();" class="btn btn-success">Обновить пароль</a>
        <a href="javascript:;" onclick="logout();" class="btn btn-danger">Выйти</a>
      </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2013-2017 <a href="http://sitecare.vn.ua">Sitecare</a>.</strong> All rights
    reserved.
  </footer>
...
<script type="text/javascript">
  function changeP()
  {
    ...
    if(newPassword)
    {
      $.post('int.php', {pass:newPassword}, function(resp){
        alert(resp);
      });
    }
    else
  ...
  function logout()
  {
    $.post('int.php', {logout:true}, function(resp){
        location.href = '/last/admin/admin.php?action=login';
      });
  }
</script>
</body>
